const cardModa = document.getElementById('moda')
const api = async () => {
    try {
        const res = await fetch('https://ifsin-a5e80-default-rtdb.firebaseio.com/ifsin/moda.json')
console.log (res);
...
if (res.status === 200){
    ...
    for (const i in datos){
        ...
        cardModa.innerHTML  += `
        <div class="text-center"><img src="img_demas/icons8-etiquetas.gif" alt="" style="width: 50px;"></div>
