const cardEmpresa = document.getElementById('empresas')
const api = async () => {
    try {
        const res = await fetch('https://ifsin-a5e80-default-rtdb.firebaseio.com/ifsin/empresas.json')
console.log (res);
...
<div class="text-center"><img src="img_demas/icons8-llamada-de-conferencia.gif"  alt="" style="width: 50px;"></div>
